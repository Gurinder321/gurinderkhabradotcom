              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                ...
                <form className="w-full lg:w-auto">
                  <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                    ...
                    />
                    <div className=" font-medium text-white hover:bg-[#2c2c2c] bg-blue-600  px-4 py-2 rounded flex items-center transition duration-150 ease-in-out cursor-pointer">
                      <span>Subscribe</span>
                    </div>
                  </div>
                  {/* Success message */}
